        ...
        if self.resume:
            ...
            if not branches:
                ...
                print(Fore.RED + "[-] " + Fore.RESET +
                      "Found no issues for nightly build with fix version " + Fore.GREEN + "'" + self.fix_version + "'" + Fore.RESET + " in Jira.")
            ...
            candidate_branch_name = Git.create_nightly_branch(self.fix_version)
            resume_code = 0
